...
public class Stage {
    ...
    public static void stage1() { // 약해용 1
        ...
        while (player.isAlive() && enemy.isAlive()) {
            ...
            if (!enemy.isAlive()) {
                ...
                // 골드 보상 지급
                User.currentUser.addGold(enemy.getReward());
    ...
    public static void stage2() { // 약해용 1, 단단해용 1
        ...
        for (Enemy enemy : enemies) {
            ...
            while (player.isAlive() && enemy.isAlive()) {
                ...
                if (!enemy.isAlive()) {
                    System.out.println(enemy.getName() + "을(를) 쓰러뜨렸다!");
                    totalReward += enemy.getReward(); // 처치한 적의 보상 누적
                    break;
                }
    ...
    public static void stage3() { // 단단해용 2
        MyCharacter player = User.currentUser.getMyCharacter();
        int dragon = 2;
        int count = 0;
        int totalReward = 0; // 누적 보상 변수
        ...
        while (count < dragon) {
            ...
            while (player.isAlive() && enemy.isAlive()) {
                ...
                if (!enemy.isAlive()) {
                    System.out.println(enemy.getName() + "을(를) 쓰러뜨렸다!");
                    totalReward += enemy.getReward(); // 처치 시 보상 누적
                    count++;
                    break;
                }
    ...
    public static void stage4() { // 단단해용 2, 나쌔용 1
        MyCharacter player = User.currentUser.getMyCharacter();
        System.out.println("\n스테이지 4 시작!");

        int count = 0;
        int totalReward = 0; // 적 처치 보상 누적 변수
        ...
        while (count < 2) {
            ...
            while (player.isAlive() && enemy.isAlive()) {
                ...
                if (!enemy.isAlive()) {
                    System.out.println(enemy.getName() + "을(를) 쓰러뜨렸다!");
                    totalReward += enemy.getReward(); // 보상 누적
                    count++;
                    break;
                }
        ...
        System.out.println("\n" + Objects.requireNonNull(enemy).getName() + "이 나타났다!");
